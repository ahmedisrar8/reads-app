...
export default class Attendance extends React.Component {
    ...
    getprofile()
    {
        ...
        fetch('http://readsschoolandcollege.edu.pk/readsform/AdminPanel/WebService/annoucement.php',{
          method:'post',
          header:{
       ...
       <StatusBar barStyle="light-content"/>
        ...
        <Left>
              ...
              <Icon style={{color:"#343333",fontSize:wp('6%')}} name="chevron-left" type="FontAwesome5"   />
                <Text style={{color:"#343333",fontSize:wp('6%'),fontWeight:"bold",marginLeft:wp('3%'),width:wp('100%'),textTransform:"capitalize",fontFamily:"manjari-bold"}}>Annoucement</Text> 
              </Button>
            </Left>
            <Body>
    ...
    <Row style={{height:1,padding:wp('4%'),backgroundColor:"#e9ebf0",borderTopLeftRadius:wp('3%'),borderTopRightRadius:wp('3%')}}>
      ...
      {this.state.dataSource.map((value, index) => {
          ...
          <Grid style={{padding:wp('3%'),justifyContent:"center",alignItems:"center",borderBottomWidth:1,borderBottomColor:"#e9ebf0",height:"auto"}}>
              ...
              <Col>
                  <Row style={{height:"auto"}}><Text style={{fontSize:wp('3%'),fontWeight:"400",color:"#ccc",fontFamily:"manjari"}}>{value["title"]}</Text></Row>
                  <Row style={{height:"auto"}}><Text style={{fontSize:wp('3.5%'),color:"#26306D",fontFamily:"manjari"}}>{value["announcement"]}</Text></Row>
              </Col>
