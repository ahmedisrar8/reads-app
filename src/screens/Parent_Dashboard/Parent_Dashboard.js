...
export default class Parent_Dashboard extends React.Component {
...
<Grid style={{height:"auto", backgroundColor:"transperent",margin:wp('3%'),borderRadius:wp('3%'), shadowRadius:5,shadowColor:"#000",shadowOpacity:0.4}} >
  ...
  <Row style={{height:"auto",padding:wp('4%'),backgroundColor:"#e9ebf0",borderTopLeftRadius:wp('3%'),borderTopRightRadius:wp('3%')}}>
        <Text style={{color:"#343333",fontWeight:"bold"}}>Your Childrens at Reads</Text>
    </Row>
     <Row style={{height:hp('15%')}}  onTouchStart={()=>{this.props.navigation.navigate("Lms_1",{id:value.courseid})}}>
        <Grid style={{padding:wp('3%'),justifyContent:"center",alignItems:"center",borderBottomWidth:1,borderBottomColor:"#e9ebf0",height:"auto"}}>
            ...
            {/* <Thumbnail circular  large style={{borderWidth:1.5,borderColor:"#F3BA1D"}} source={require('../../src/img/boy.png')}  /> */}
            </Col>
            <Col>
                <Row style={{height:"auto"}}><Text style={{fontSize:wp('3%'),fontWeight:"400",color:"#ccc"}}>20083</Text></Row>
                <Row style={{height:"auto"}}><Text style={{fontSize:wp('5%'),fontWeight:"bold",color:"#26306D"}}>Shawaiz Kashif</Text></Row>
            </Col>
