...
export default class Communication extends React.Component {
    ...
    getprofile()
    {
        ...
        fetch('http://readsschoolandcollege.edu.pk/readsform/AdminPanel/WebService/comm.php',{
          method:'post',
          header:{
       ...
       <StatusBar barStyle="light-content"/>
        ...
        <Left>
              <Button style={{height:'auto'}} transparent onPress={() => this.props.navigation.goBack()}>
                ...
                <Text style={{color:"#343333",fontSize:wp('6%'),fontWeight:"bold",marginLeft:wp('3%'),width:wp('100%'),textTransform:"capitalize",fontFamily:"manjari-bold"}}>Communication</Text> 
              </Button>
            </Left>
            <Body>
    ...
    <Row style={{height:1,padding:wp('4%'),backgroundColor:"#e9ebf0",borderTopLeftRadius:wp('3%'),borderTopRightRadius:wp('3%')}}>
      ...
      {this.state.dataSource.map((value, index) => {
          ...
          <Grid style={{padding:wp('3%'),justifyContent:"center",alignItems:"center",borderBottomWidth:1,borderBottomColor:"#e9ebf0",height:"auto"}}>
              ...
              <Icon name="bullhorn" style={{color:"#26306D",fontSize:wp('9%')}} type="FontAwesome5" ></Icon>
              </Col>
              <Col>
              <Row style={{height:"auto"}}><Text style={{fontSize:wp('3%'),fontWeight:"400",color:"#ccc",fontFamily:"manjari"}}>{value["datetime"]}</Text></Row>
                  <Row style={{height:"auto"}}><Text style={{fontSize:wp('3%'),fontWeight:"400",color:"#ccc",fontFamily:"manjari"}}>{value["type"]}</Text></Row>
                  <Row style={{height:"auto"}}><Text style={{fontSize:wp('3.5%'),fontWeight:"bold",color:"#26306D",fontFamily:"manjari"}}>{value["description"]}</Text></Row>
              </Col>
